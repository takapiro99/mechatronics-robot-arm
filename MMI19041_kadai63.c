...
void main (void) {
  ...
  EI;
  while (1) {
    raw = ADBuf-> DATA; // 0-1023 の値が adv に代入される
    // 433 + -6.24x + 0.0356x^2 + -8.94E-05x^3 + 8.12E-08x^4 で近似 
    adv = (int)(8.12 * pow(10, -8) * pow(raw, 4) - 8.94 * pow(10, -5) * pow(raw, 3) + 0.0356 * pow(raw, 2) - 6.24 * raw + 433);
    int third;
    int second;
    int first;
